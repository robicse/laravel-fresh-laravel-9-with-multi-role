...
<head>
    ...
    <script type="text/javascript">
        window.location.href = "https://demos.creative-tim.com/argon-dashboard-pro/pages/dashboards/landing"
    </script>
    <meta charset="utf-8" />
...
<body class="g-sidenav-show  bg-gray-100">
                    ...
                    <div class="collapse " id="dashboardsExamples">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item ">
                                ...
                                <a class="nav-link " href="./dashboards/landing.html">
    ...
    <main class="main-content border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky  blur blur-rounded top-0 z-index-fixed shadow position-absolute"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0 text-white">index</h6>
        ...
        <div class="container-fluid py-4">
            ...
            <h6>If you are not redirected automatically, follow <a
                    href=" https://demos.creative-tim.com/argon-dashboard-pro/pages/dashboards/default.html ">this
                    link</a>.</h6>
            <div class="row">
