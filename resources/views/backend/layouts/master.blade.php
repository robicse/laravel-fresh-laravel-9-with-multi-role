    ...
    {{-- <div class="fixed-plugin">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0 overflow-auto">
                ...
                <div class="d-flex">
                    <button class="btn bg-gradient-primary w-100 px-3 mb-2" data-class="bg-white"
                        onclick="sidebarType(this)">White</button>
                    <button class="btn bg-gradient-primary w-100 px-3 mb-2 active me-2" data-class="bg-default"
