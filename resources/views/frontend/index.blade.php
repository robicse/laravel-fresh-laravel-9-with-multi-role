...
@section('content')
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="main-slider-shape-1 float-bob-x">
                        <img src="{{ asset('frontend/assets/images/shapes/main-slider-shape-1.png') }}" alt="">
                    </div>
                        ...
                        <div class="feature-one__single">
                            <div class="feature-one__single-inner">
                                ...
                                <div class="feature-one__shape">
                                    <img src="{{ asset('frontend/assets/images/shapes/feature-one-shape-1.png') }}" alt="">
                                </div>
    ...
    <section class="about-one">
        <div class="about-one-bg wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms"
            style="background-image: url({{ asset('frontend/assets/images/backgrounds/about-one-bg.png') }});"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="about-one__left">
                        <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <div class="about-one__shape-1">
                                <img src="{{ asset('frontend/assets/images/shapes/about-one-shape-1.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="about-one__btn-call">
                            ...
                            <div class="about-one__call">
                                ...
                                <div class="about-one__call-content">
                                    <a href="tel:281-809-0090">(281) 809-0090</a>
            ...
            <div class="services-one__container">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('frontend/assets/images/services/services-1-4.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('frontend/assets/images/services/services-1-5.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('frontend/assets/images/services/services-1-6.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="700ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('frontend/assets/images/services/services-1-7.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="800ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('frontend/assets/images/services/services-1-8.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
    ...
    <section class="why-choose-one">
        <div class="why-choose-one-shape-1"
            style="background-image: url({{ asset('frontend/assets/images/shapes/why-choose-one-shape-1.png') }});"></div>
        ...
        <div class="why-choose-one-shape-3 float-bob-x">
            <img src="{{ asset('frontend/assets/images/shapes/why-choose-one-shape-3.png') }}" alt="">
        </div>
        <div class="why-choose-one-shape-4 float-bob-y">
            <img src="{{ asset('frontend/assets/images/shapes/why-choose-one-shape-4.png') }}" alt="">
        </div>
        <div class="why-choose-one-shape-5 float-bob-y">
            <img src="{{ asset('frontend/assets/images/shapes/why-choose-one-shape-5.png') }}" alt="">
        </div>
        <div class="why-choose-one-shape-6 float-bob-x">
            <img src="{{ asset('frontend/assets/images/shapes/why-choose-one-shape-6.png') }}" alt="">
        </div>
        <div class="why-choose-one-img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
            <img src="{{ asset('frontend/assets/images/resources/why-choose-one-img.png') }}" alt="">
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left">
                            <div class="section-sub-title-box">
                                ...
                                <div class="section-title-shape-1">
                                    <img src="{{ asset('frontend/assets/images/shapes/section-title-shape-3.png') }}" alt="">
                                </div>
                                <div class="section-title-shape-2">
                                    <img src="{{ asset('frontend/assets/images/shapes/section-title-shape-4.png') }}" alt="">
                                </div>
                            </div>
    ...
    <section class="get-insurance">
        <div class="get-insurance-bg"
            style="background-image: url({{ asset('frontend/assets/images/backgrounds/get-insurance-bg.png);') }}"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="get-insurance__left">
                        <div class="get-insurance__img wow slideInLeft" data-wow-delay="100ms"
                            data-wow-duration="2500ms">
                            <img src="{{ asset('frontend/assets/images/resources/get-insurance-img-1.png') }}" alt="">
                        </div>
                        ...
                        <div class="get-insurance__shape-1 float-bob-x">
                            <img src="{{ asset('frontend/assets/images/shapes/get-insurance-shape-1.png') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                                ...
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        <div class="testimonial-one__shape-1">
                                            <img src="{{ asset('frontend/assets/images/shapes/testimonial-one-shape-1.png') }}" alt="">
                                        </div>
        ...
        <div class="container">
            <div class="tracking__inner">
                <div class="tracking-shape-1 float-bob-y">
                    <img src="{{ asset('frontend/assets/images/shapes/tracking-shape-1.png') }}" alt="">
                </div>
                <div class="tracking-shape-2 float-bob-x">
                    <img src="{{ asset('frontend/assets/images/shapes/tracking-shape-2.png') }}" alt="">
                </div>
                <div class="tracking-shape-3 float-bob-x">
                    <img src="{{ asset('frontend/assets/images/shapes/tracking-shape-3.png') }}" alt="">
                </div>
                <div class="tracking-shape-4 float-bob-y">
                    <img src="{{ asset('frontend/assets/images/shapes/tracking-shape-4.png') }}" alt="">
                </div>
